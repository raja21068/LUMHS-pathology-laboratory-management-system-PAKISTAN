...
public class UpdateReceiptDialog extends javax.swing.JDialog {
    
    
    public UpdateReceiptDialog(javax.swing.JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(433, 640, 130, 30);
        ...
        deleteButton.setBounds(303, 640, 120, 30);
        ...
        doctorNameText.setText("Dr. Hameeda Jaghrani");
    ...
    private void calculateTotal(){
        ...
        for(int k=0 ; k<defaultTableModel.getRowCount() ; k++){
            charges += ((Integer)defaultTableModel.getValueAt(k, 1)).intValue();
        }
